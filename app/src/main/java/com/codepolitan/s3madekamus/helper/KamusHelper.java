...
import com.codepolitan.s3madekamus.database.DatabaseHelper;
...
public class KamusHelper {
    ...
    public List<KamusModel> getDataByName(String search, boolean isEnglish) {
    ...
    public List<KamusModel> getAllData(boolean isEnglish) {
        KamusModel kamusModel;
    ...
    public void insertTransaction(List<KamusModel> kamusModels, boolean isEnglish) {
        String DATABASE_TABLE = isEnglish ? ENGLISH : INDONESIA;
